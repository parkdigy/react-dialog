import React,{createContext,useId,useRef,useState,useEffect,useMemo,useCallback,useLayoutEffect,Component,useContext}from'react';import {useTheme,styled,Box,Icon,Dialog as Dialog$1,DialogTitle,IconButton,DialogContent,DialogActions,Button}from'@mui/material';import {useAutoUpdateLayoutRef,useAutoUpdateState,useForwardRef}from'@pdg/react-hook';/******************************************************************************
...
};var DialogContext = createContext(DialogContextDefaultValue);var __disableEnforceFocusListeners = [];
var Dialog = React.forwardRef(function (_a, ref) {
    ...
    var _e = useAutoUpdateState(initDisableEnforceFocus), disableEnforceFocus = _e[0], setDisableEnforceFocus = _e[1];
    /********************************************************************************************************************
     * Memo
     * ******************************************************************************************************************/
     ...
     * Memo
     * ******************************************************************************************************************/
    var finalContentProps = useMemo(function () {

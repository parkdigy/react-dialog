...
var templateObject_1, templateObject_2, templateObject_3;var Dialog = React.forwardRef(function (_a, ref) {
    ...
    var backgroundColor = useAutoUpdateState(useCallback(function () {
    ...
    var titleProps = useAutoUpdateState(useCallback(function () {
    ...
    // Render ----------------------------------------------------------------------------------------------------------
    return (React.createElement(StyledDialog, __assign({ open: open, "aria-labelledby": titleId, onClose: handleClose }, otherProps),

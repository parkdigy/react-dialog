import {c}from'react/compiler-runtime';import React,{createContext,useId,useRef,useState,useEffect,useImperativeHandle,useLayoutEffect,useContext}from'react';import {styled,Dialog as Dialog$1,DialogTitle,IconButton,DialogContent,DialogActions,useTheme,Box,Icon,Button}from'@mui/material';import {useAutoUpdateRef,useAutoUpdateState}from'@pdg/react-hook';import {withErrorBoundary,useErrorBoundary}from'react-use-error-boundary';function _arrayLikeToArray(r, a) {
...
}var DialogContext = /*#__PURE__*/createContext({});var _templateObject$1, _templateObject2, _templateObject3;
...
var Dialog = function Dialog(t0) {
  ...
  var id = useId();
  var theme = useTheme();
  var onShowRef = useRef(onShow);
  var contentRef = useRef(null);
  var onRequestCloseRef = useAutoUpdateRef(initOnRequestClose);
  ...
  if ($[65] !== color || $[66] !== handleCloseClick || $[67] !== hideClose || $[68] !== subTitle || $[69] !== theme.palette || $[70] !== title || $[71] !== titleIcon || $[72] !== titleProps || $[73] !== titleStyle) {
    t27 = title && /*#__PURE__*/React.createElement(StyledDialogTitle, _extends({
      ...
      display: "flex",
      fontSize: 17
    }, titleIcon && /*#__PURE__*/React.createElement(Box, {
      display: "flex",
      alignItems: "center",
      marginRight: "7px"
    ...
    }, titleIcon)), title && /*#__PURE__*/React.createElement(Box, {
      display: "flex",
      alignItems: "center"
...
var StyledDialog = styled(Dialog$1)(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral(["\n  &.Dialog-full-height {\n    > .MuiDialog-container > .MuiDialog-paper {\n      height: 100vh;\n    }\n  }\n  > .MuiDialog-container > .MuiDialog-paper:not(.MuiDialog-paperFullScreen) {\n    width: calc(100% - ", "px);\n    max-height: calc(100% - ", "px);\n    margin: 0;\n  }\n"])), function (props) {
  return props['data-margin'] * 2;
}, function (props) {
  return props['data-margin'] * 2;
});
var StyledDialogTitle = styled(DialogTitle)(function () {
  return {
    position: 'relative',
    paddingRight: 60,
    paddingTop: 10,
...
var StyleDialogTitleCloseButton = styled(IconButton)(function (_ref) {
...
var StyledDialogContent = styled(DialogContent)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  flex: 1;\n  display: flex;\n  flex-direction: column;\n"])));
var StyledDialogActions = styled(DialogActions)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  padding-left: 20px;\n  padding-right: 15px;\n"])));
...
var ConfirmDialog = function ConfirmDialog(t0) {
  ...
  var _useErrorBoundary = useErrorBoundary(function (error, errorInfo) {

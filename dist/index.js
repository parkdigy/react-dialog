...
var Dialog = function Dialog(t0) {
  ...
  var _useState3 = React.useState(initDisableEnforceFocus),
    _useState4 = _slicedToArray(_useState3, 2),
    disableEnforceFocus = _useState4[0],
    setDisableEnforceFocus = _useState4[1];
  var _useState5 = React.useState(initDisableEnforceFocus),
...
var ConfirmDialog = function ConfirmDialog(t0) {
  ...
  reactHook.useForwardRef(ref, commands, t7);
  var t8;
  if ($[22] !== initStyle) {
    t8 = _objectSpread2({
      zIndex: 1399
  ...
  if ($[30] !== content || $[31] !== textColor) {
    t12 = /*#__PURE__*/React.createElement(material.Box, {
      textAlign: "center",
      py: 2,
      fontSize: 14,
      color: textColor
